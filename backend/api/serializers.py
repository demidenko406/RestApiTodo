...
class UserSerializer(serializers.ModelSerializer):
    ...
    def validate_password(self,value):
        if len(value) < 8:
            ...
            raise serializers.ValidationError("Password is too short. Enter at least 8 symbols")
        return value
    
    def validate_email(self,value):
        if len(value) < 5:
            logger.warning("Wrong email was provided")
            raise serializers.ValidationError("Email is too short. Enter at least 5 symbols")
        return value
    ...
    def validate_username(self,value):
        if len(value) < 5:
            ...
            raise serializers.ValidationError("Username is too short. Enter at least 5 symbols")
        return value
