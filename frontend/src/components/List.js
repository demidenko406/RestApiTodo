								...
								{if(!task.complete){
										...
										<div style = {{display:'inline'}} key = {task.id}> 
											<div className = "Task" style = {{ display:'flex' }} >
												...
												<div className = "Buttons">
													<button  style = {{ margin:'10px'}} className="btn btn-outline-success" onClick = {() =>{setComplete({...task,complete:!task.complete});}} >Complete</button>
									...
									return(         
										<div className = "Task" style = {{ display:'flex' }}  key = {task.id} >
											...
											<div className = "Buttons">
												<button  style = {{ margin:'10px'}} className="btn btn-outline-primary" onClick = {() =>{setComplete({...task,complete:!task.complete});}} >unComplete</button>
